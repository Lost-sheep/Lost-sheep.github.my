app.controller('bookController',['$scope',function ($scope,bookController) {
  $scope.bookTypes = [
    {id:'fairytale',name:'儿童',img:'http://img3x0.ddimg.cn/36/33/24010110-1_l_6.jpg',description:'《太空猫：物理大爆炸》'},
    {id:'history',name:'历史',img:'http://img3x8.ddimg.cn/1/20/24027598-1_l_1.jpg',description:'《中国史纲》'},
    {id:'novel',name:'小说',img:'http://img3x4.ddimg.cn/73/26/23978764-1_l_22.jpg',description:'《丹麦女孩》'},
